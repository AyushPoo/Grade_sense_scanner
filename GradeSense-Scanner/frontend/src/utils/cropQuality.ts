...
const BORDER_HUG_TOLERANCE_RATIO = 0.025;
const MIN_AREA_RATIO = 0.40;
const MIN_BBOX_WIDTH_RATIO = 0.60;
const MIN_BBOX_HEIGHT_RATIO = 0.60;
const MIN_RECTANGULARITY = 0.70;
